...
namespace PalotaInterviewCS
{
    ...
    public class CountryBodeering
    {
        
        [JsonProperty("countryWithBorderingCountries")]
        string CountryWithBorderingCountries { get; set; }
        [JsonProperty("numberOfBorderingCountries")]
        int NumberOfBorderingCountries { get; set; }
        [JsonProperty("combinedPopulation")]
        int CombinedPopulation { get; set; }
    }
        public enum Region
    {
        [EnumMember(Value = "")]
